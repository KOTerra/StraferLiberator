		...
		try {
			...
			while (fin.hasNext()) {
				...
				if (tip.equalsIgnoreCase("Item:")) {
					...
					WorldListener worldListener = (WorldListener) player.getWorld().getObjects(WorldListener.class)
							.get(0);
					...
					player.setLocation(player.getWorldX() - Scroller.scrolledX,
							player.getWorldY() - Scroller.scrolledY);
