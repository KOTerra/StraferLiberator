...
public class Tsoukalos extends FriendlyNpc {
	private PlayWorld playWorld;
	private String dialogFile;

	private int nrDialog;

	GifImage img = StraferLiberator.assetManager.get("images/npc/friendly/tsoukalos_idle.gif", GifImage.class);
	...
	public void addDialogs() {
		getWorld().addObject(new Dialog(this, "Tsoukalos", nrDialog), WorldData.WIDTH / 2, WorldData.HEIGHT * 7 / 10);
	}
