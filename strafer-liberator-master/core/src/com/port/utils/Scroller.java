...
public class Scroller {
	 ...
	 * the given total scrolling area, it will be tiled If 'image' is null, the
	 ...
	 *                  the given value must be at least equal to the width of
	 *                  'viewWorld' and is given in world cells (not in pixels)
	 * @param high      the height of the visible area encompassed through
	 *                  scrolling; the given value must be at least equal to the
	 *                  height of 'viewWorld' and is given in world cells (not in
	 *                  pixels)
	 */
	...
	/**
	 * performs scrolling on 'world' by the given distances along the horizontal and
	 * vertical; if 'limited' is false, requested distances are actual scrolling
	 * distances; if 'limited' is true, the distances may be adjusted due to the
	 * limits of scrolling
	 *
